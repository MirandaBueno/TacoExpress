...
void init(int width, int height, std::string strTitle, bool bFullScreen) {
	...
	boxCollider.setColor(glm::vec4(0.3, 0.0, 0.3, 0.0));
	...
	camera->setPosition(glm::vec3(-15.0, 11.0, 1.0));
...
void applicationLoop() {
	...
	modelMatrixBurnersTable = glm::translate(modelMatrixBurnersTable, glm::vec3(1.0, 0.0, 1.0));
	modelMatrixBurnersTable = glm::scale(modelMatrixBurnersTable, glm::vec3(0.5, 0.5, 0.5));

	modelMatrixChoppingTable = glm::translate(modelMatrixChoppingTable, glm::vec3(1.0, 0.0, 1.0));
	...
	while (psi) {
		...
		modelMatrixColliderDishesTable = glm::scale(modelMatrixColliderDishesTable, glm::vec3(0.5,0.5,0.5));
		modelMatrixColliderDishesTable = glm::translate(modelMatrixColliderDishesTable, glm::vec3(15.0, 2.0, -1.0));
		dishesTableCollider.c = glm::vec3(modelMatrixColliderDishesTable[3]);
		dishesTableCollider.e = modelDishesTable.getObb().e * glm::vec3(0.5,0.5,0.5);
		...
		modelMatrixColliderChoppingTable = glm::scale(modelMatrixColliderChoppingTable, glm::vec3(0.5, 0.5, 0.5));
		modelMatrixColliderChoppingTable = glm::translate(modelMatrixColliderChoppingTable, glm::vec3(1.0, 3.0, -28.0));
		choppingTableCollider.c = glm::vec3(modelMatrixColliderChoppingTable[3]);
		choppingTableCollider.e = modelChoppingTable.getObb().e * glm::vec3(0.5, 0.5, 0.5);
		...
		modelMatrixColliderBurnerTable = glm::scale(modelMatrixColliderBurnerTable, glm::vec3(0.5, 0.5, 0.5));
		modelMatrixColliderBurnerTable = glm::translate(modelMatrixColliderBurnerTable, glm::vec3(0.0, 2.0, 26.0));
		burnerTableCollider.c = glm::vec3(modelMatrixColliderBurnerTable[3]);
		burnerTableCollider.e = modelBurnersTable.getObb().e * glm::vec3(0.5, 0.5, 0.5);
		...
		modelMatrixColliderIngredientsTable = glm::scale(modelMatrixColliderIngredientsTable, glm::vec3(0.5, 0.5, 0.5));
		modelMatrixColliderIngredientsTable = glm::translate(modelMatrixColliderIngredientsTable, glm::vec3(-15.0, 3.0, -1.0));
		ingredientsTableCollider.c = glm::vec3(modelMatrixColliderIngredientsTable[3]);
		ingredientsTableCollider.e = modelIngredientsTable.getObb().e * glm::vec3(0.5, 0.5, 0.5);
		...
		modelmatrixColliderChef = glm::scale(modelmatrixColliderChef, glm::vec3(0.5, 0.2, 1.5));
		modelmatrixColliderChef = glm::translate(modelmatrixColliderChef, glm::vec3(0.0, 0.0, 1.0));
		chefCollider.e = chefModelAnimate.getObb().e * glm::vec3(0.5, 0.2, 1.5) * glm::vec3(0.787401574, 0.787401574, 0.787401574);
